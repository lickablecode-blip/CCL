/*
* Name:     Note Types Satisfying Documentation Requirements
* Source:   Inbox/Notes & Templates/Note Types Satisfying Documentation Requirements.txt
* Purpose:
* Imported: 2026-05-15
...
elseif(v.parent_entity_name = "ALT_SEL_CAT") qf.long_description
...
/****************************************************************************************/
and m.category_mean in ("*") ;Set MPage Identifier to search by MPage (set this or name not both)
/****************************************************************************************/
and m.category_name in ("Ambulatory Organizer") ;Set MPage Name to search by MPage (set this or identifier, not both)
/****************************************************************************************/
join r
...
join qf
where outerjoin(v.parent_entity_id) = qf.alt_sel_category_id
join n
