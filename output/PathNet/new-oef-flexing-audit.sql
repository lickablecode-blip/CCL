/*
* Name:     new_oef_flexing_audit
* Source:   Inbox/PathNet/new_oef_flexing_audit.txt
* Purpose:
* Imported: 2026-05-15
...
head report
  ...
  col 40 "FLEX TYPE"
  col 60 "FLEX VALUE"
  col 90 "BASE ACCEPT FLAG"
  col 110 "FLEX ACCEPT FLAG"
  col 130 "DEFAULT VALUE"
  row+1
  col 5 "**********"
  col 40 "*********"
  col 60 "**********"
...
head a.oe_field_id
  col 5 field_name
detail					;detail added 7/14  
  case(a.flex_type_flag)
  of 0:
    col 40 "Order Location"
  of 1:
    col 40 "Patient Location"
  of 2:
    col 40 "Application"
  of 3:
    col 40 "Position"
  of 4:
    col 40 "Encounter Type"
  endcase
  ...
  of 1:
    col 110 "Optional"
  of 2:
    col 110 "Do Not Display"
  of 3:
    col 110 "Display Only"
  endcase

  col 130 a.default_value
  row+1
foot a.oe_format_id
  row+1
with maxcol=250
