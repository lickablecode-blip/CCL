/*
* Name:     GL and Micro orders in PowerPlans
* Source:   Inbox/PathNet/GL and Micro orders in PowerPlans.txt
* Purpose:
* Imported: 2026-05-15
...
SELECT
	...
	, OCS_ACTIVITY_TYPE_DISP = UAR_GET_CODE_DISPLAY(OCS.ACTIVITY_TYPE_CD)
...
join ocs
		...
		and ocs.activity_type_cd in (692,696)
		
join pcat
	
		where pcat.pathway_catalog_id = pc.pathway_catalog_id
		and pcat.active_ind = 1
		and pcat.pathway_type_cd = (select cv.code_value from code_value cv where cv.code_set = 30183 and cv.display = "Medical")

		and pcat.beg_effective_dt_tm < cnvtdatetime("01-JAN-2100 0")
