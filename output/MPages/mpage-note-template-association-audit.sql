/*
* Name:     MPage Note Template Association Audit
* Source:   Inbox/mPages/MPage Note Template Association Audit.txt
* Purpose:
* Imported: 2026-05-15
...
/****************************************************************************************/  
  ;and m.category_mean = "VB_STLABBMPLAST24HOURS" ;Set MPage Identifier to search by MPage  
/****************************************************************************************/  
join r  
...
/****************************************************************************************/  
  and f.filter_display in ("Note Type/Dynamic Doc Template Associations") ;Modify to filter by MPage filter display - Please make sure it's the same capitalization as the filter in bedrock  
/****************************************************************************************/  
join v  
...
ORDER BY
              ...
              , f.filter_seq
                ...
                WITH MAXREC = 50000, dontcare = c, time =30
