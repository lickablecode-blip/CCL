 ...
 * Anchor       : What appointment types and locations are associated with a request list?
 * Block index  : 8 of 8
 * Detected lang: ccl
 * Lines        : 26
 *
...
,location = UAR_GET_CODE_DISPLAY(sar.location_cd)
...
ORDER BY
request_list, associated_appt_type, location
WITH TIME=30
